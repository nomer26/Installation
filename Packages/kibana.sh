...
then
  ...
  then
    ...
    curl -O -L https://artifacts.elastic.co/downloads/kibana/kibana-8.4.3-linux-x86_64.tar.gz
  ...
  then
    curl -O -L https://artifacts.elastic.co/downloads/kibana/kibana-7.17.1-linux-x86_64.tar.gz
...
EOF'
  ...
  sudo yum install --enablerepo=kibana kibana -y
